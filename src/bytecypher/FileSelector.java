...
//     static {
//         try {
//             UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName()); // Cross-platform native UI
...
//         fileChooser.setPreferredSize(new Dimension(500, 375));
...
//         JFileChooser fileChooser = createFileChooser("Select a File to Compress", JFileChooser.FILES_ONLY, "Choose a file you want to compress");
//         int userSelection = fileChooser.showOpenDialog(null);
//         return (userSelection == JFileChooser.APPROVE_OPTION) ? fileChooser.getSelectedFile().getAbsolutePath() : null;
//     }

//     public static String selectFolder() {
//         JFileChooser fileChooser = createFileChooser("Select a Folder to Compress", JFileChooser.DIRECTORIES_ONLY, "Choose a folder you want to compress");
//         int userSelection = fileChooser.showOpenDialog(null);
//         return (userSelection == JFileChooser.APPROVE_OPTION) ? fileChooser.getSelectedFile().getAbsolutePath() : null;
//     }

//     public static String selectSaveLocation() {
//         JFileChooser fileChooser = createFileChooser("Select a Save Location", JFileChooser.DIRECTORIES_ONLY, "Choose where to save the compressed file");
...
//                 };
//                 int option = JOptionPane.showConfirmDialog(null, message, "Save File", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
...
//                     return selectedDirectory.getAbsolutePath() + File.separator + fileName + ".zip";
//                 }
//                 JOptionPane.showMessageDialog(null, "Invalid file name! Use letters, numbers, '-' or '_'.", "Error", JOptionPane.ERROR_MESSAGE);
//             }
//         }
//         return null;
//     }
