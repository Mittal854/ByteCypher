...
//             compressAndAddToZip(inputFile, zos);
//             System.out.println("Compression successful! ZIP file saved at: " + savePath);
//         } catch (IOException e) {
//             System.out.println("Compression failed: " + e.getMessage());
//         }
//     }

//     private static void compressAndAddToZip(File file, ZipOutputStream zos) throws IOException {
//         byte[] fileBytes = Files.readAllBytes(file.toPath());

//         // Use an instance of HuffmanCompression to preserve the tree information.
//         HuffmanCompression huffman = new HuffmanCompression();
//         byte[] huffmanCompressed = huffman.compress(fileBytes);
//         System.out.println("After Huffman: " + java.util.Arrays.toString(java.util.Arrays.copyOf(huffmanCompressed, Math.min(20, huffmanCompressed.length))));

//         // Create a zip entry with a custom extension (".bc")
//         ZipEntry zipEntry = new ZipEntry(file.getName() + ".bc");
//         zos.putNextEntry(zipEntry);

//         // Write the Huffman tree and compressed data to the zip entry using ObjectOutputStream.
//         ObjectOutputStream oos = new ObjectOutputStream(zos);
//         oos.writeObject(huffman.getTree());         // Save the Huffman tree
//         oos.writeInt(huffmanCompressed.length);       // Save the length of the compressed data
//         oos.write(huffmanCompressed);                 // Save the compressed data
//         oos.flush();
//         zos.closeEntry();
//     }
// }
...
//     //     } else if (isImageFile(fileExtension) || isMediaFile(fileExtension)) {
//     //         // For media files, just store as is (these are usually already compressed)
//     //         compressedData = fileBytes;
//     //         compressionMethod = "store";
//     //         System.out.println("Storing already compressed file: " + file.getName());
//     //     } else {
//     //         // Use LZ77 for binary and other files
...
//     //     ZipEntry zipEntry = new ZipEntry(entryName + ".bc");
//     //     zos.putNextEntry(zipEntry);

//     //     // Write compression method, original size, and compressed data
...
//         // IMPORTANT CHANGE: Use a new DataOutputStream that doesn't close the underlying stream
...
//         return extension.matches("txt|html|css|js|java|py|c|cpp|h|xml|json|md|csv|log");
//     }

//     private static boolean isImageFile(String extension) {
//         return extension.matches("jpg|jpeg|png|gif|bmp|tiff|webp|svg");
//     }

//     private static boolean isMediaFile(String extension) {
//         return extension.matches("mp3|mp4|avi|mov|mkv|flac|wav|ogg|webm|pdf");
//     }
// }
